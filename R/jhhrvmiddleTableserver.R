...
viewmiddleTableserver <- function(input,output,session,dms_token) {
  ...
  shiny::observe({
    shiny::observeEvent(input$btn_hrv_ods_view_middleTable,
                        {
                            sql = 'select * from rds_hrv_ods_ds_middleTable'
                            ...
                            #显示数据
                            tsui::run_dataTable2(id = 'hrv_ods_view_data_middleTable', data = data)
